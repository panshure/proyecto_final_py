...
<title>TF_Flores_20202566</title><script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"></script>
...
<h1 id="Proyecto-Final">Proyecto Final<a class="anchor-link" href="#Proyecto-Final">&#182;</a></h1><p>Hora de entrega: 16 de ene de 2024, hasta 23:59</p>
<p>Nombres y apellidos: Fabricio Alexander Flores Quispe
Código PUCP:20202566</p>
<p>Entregar la tarea en este notebook, no usar una adicional a esta.</p>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="o">!</span>pip<span class="w"> </span>install<span class="w"> </span>pandas<span class="w"> </span>openpyxl
</pre></div>
...
<pre>Requirement already satisfied: pandas in c:\users\fabri\anaconda3\lib\site-packages (2.0.3)
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">archivo_csv</span> <span class="o">=</span> <span class="sa">r</span><span class="s2">"C:\Users\Fabri\Downloads\datatrabajo.csv"</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">df</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_csv</span><span class="p">(</span><span class="n">archivo_csv</span><span class="p">,</span><span class="n">encoding</span> <span class="o">=</span> <span class="s2">"latin-1"</span><span class="p">)</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">columnas_a_eliminar</span> <span class="o">=</span> <span class="nb">list</span><span class="p">(</span><span class="nb">range</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">44</span><span class="p">))</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">df_sin_columnas</span> <span class="o">=</span> <span class="n">df</span><span class="o">.</span><span class="n">drop</span><span class="p">(</span><span class="n">df</span><span class="o">.</span><span class="n">columns</span><span class="p">[</span><span class="n">columnas_a_eliminar</span><span class="p">],</span> <span class="n">axis</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">df_sin_columnas</span><span class="p">)</span>
</pre></div>
...
<span class="k">def</span> <span class="nf">seleccion_filas_columnas</span><span class="p">(</span><span class="n">df</span><span class="p">,</span> <span class="n">filas</span><span class="p">,</span> <span class="n">columnas</span><span class="p">):</span>
<span class="w">    </span><span class="sd">"""</span>
<span class="sd">    Selecciona filas y columnas específicas de una base de datos (indicadores de desarrollo global a nivel país).</span>

<span class="sd">    Inputs:</span>
<span class="sd">    - df: La base de datos sin limpiar.</span>
<span class="sd">    - filas: Lista de números de filas seleccionadas.</span>
<span class="sd">    - columnas: Lista de números de columnas seleccionadas.</span>

<span class="sd">    Output:</span>
<span class="sd">    - pd.DataFrame: Base de datos modificada con las filas y columnas seleccionadas.</span>
<span class="sd">    """</span>
    <span class="n">nueva_data</span> <span class="o">=</span> <span class="n">df</span><span class="o">.</span><span class="n">iloc</span><span class="p">[</span><span class="n">filas</span><span class="p">,</span> <span class="n">columnas</span><span class="p">]</span>
    <span class="k">return</span> <span class="n">nueva_data</span>

<span class="n">df_sin_columnas</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">(</span><span class="n">df</span><span class="p">)</span>

<span class="n">filas_seleccionadas</span> <span class="o">=</span> <span class="p">[</span><span class="mi">43</span><span class="p">,</span> <span class="mi">139</span><span class="p">,</span> <span class="mi">157</span><span class="p">]</span>
<span class="n">columnas_seleccionadas</span> <span class="o">=</span> <span class="p">[</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span><span class="mi">44</span><span class="p">,</span><span class="mi">45</span><span class="p">,</span> <span class="mi">46</span><span class="p">,</span> <span class="mi">47</span><span class="p">,</span> <span class="mi">48</span><span class="p">,</span> <span class="mi">49</span><span class="p">]</span>

<span class="n">data_seleccion</span> <span class="o">=</span> <span class="n">seleccion_filas_columnas</span><span class="p">(</span><span class="n">df_sin_columnas</span><span class="p">,</span> <span class="n">filas_seleccionadas</span><span class="p">,</span> <span class="n">columnas_seleccionadas</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">data_seleccion</span><span class="p">)</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">data_seleccion</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">pip</span> <span class="n">install</span> <span class="n">matplotlib</span> <span class="n">seaborn</span>
</pre></div>
...
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain">
<pre>Requirement already satisfied: matplotlib in c:\users\fabri\anaconda3\lib\site-packages (3.7.2)
...
<span class="n">paises</span> <span class="o">=</span> <span class="p">[</span><span class="s1">'Argentina'</span><span class="p">,</span> <span class="s1">'Bolivia'</span><span class="p">,</span> <span class="s1">'Brasil'</span><span class="p">]</span>
<span class="n">porcentaje_poblacion_rural</span> <span class="o">=</span> <span class="p">[</span><span class="mf">91.79</span><span class="p">,</span> <span class="mf">28.16</span><span class="p">,</span> <span class="mf">74.60</span><span class="p">]</span>

<span class="n">plt</span><span class="o">.</span><span class="n">pie</span><span class="p">(</span><span class="n">porcentaje_poblacion_rural</span><span class="p">,</span> <span class="n">labels</span><span class="o">=</span><span class="n">paises</span><span class="p">,</span> <span class="n">autopct</span><span class="o">=</span><span class="s1">'</span><span class="si">%1.1f%%</span><span class="s1">'</span><span class="p">,</span> <span class="n">startangle</span><span class="o">=</span><span class="mi">90</span><span class="p">)</span>

<span class="n">plt</span><span class="o">.</span><span class="n">title</span><span class="p">(</span><span class="s1">'Distribución del acceso a la electricidad rural en el año 2000'</span><span class="p">)</span>
...
<img src="data:image/png;base64,"
class="
"
>
</div>
...
<span class="n">paises</span> <span class="o">=</span> <span class="p">[</span><span class="s1">'Argentina'</span><span class="p">,</span> <span class="s1">'Bolivia'</span><span class="p">,</span> <span class="s1">'Brasil'</span><span class="p">]</span>
<span class="n">porcentaje_poblacion_rural</span> <span class="o">=</span> <span class="p">[</span><span class="mf">93.4174966806644</span><span class="p">,</span> <span class="mf">29.5450096623227</span><span class="p">,</span> <span class="mf">84.8305341166813</span><span class="p">]</span>

<span class="n">plt</span><span class="o">.</span><span class="n">bar</span><span class="p">(</span><span class="n">paises</span><span class="p">,</span> <span class="n">porcentaje_poblacion_rural</span><span class="p">,</span> <span class="n">color</span><span class="o">=</span><span class="s1">'blue'</span><span class="p">)</span>

<span class="n">plt</span><span class="o">.</span><span class="n">xlabel</span><span class="p">(</span><span class="s1">'País'</span><span class="p">)</span>
<span class="n">plt</span><span class="o">.</span><span class="n">ylabel</span><span class="p">(</span><span class="s1">'Porcentaje de la población rural'</span><span class="p">)</span>
<span class="n">plt</span><span class="o">.</span><span class="n">title</span><span class="p">(</span><span class="s1">'Acceso a la electricidad, rural (</span><span class="si">% d</span><span class="s1">e la población rural) en el año 2005'</span><span class="p">)</span>
